...
class GAToptConv(MessagePassing):
    r"""The GAToptConv operator from the `"Optimization and Interpretability of 
    ...
    layer, done by https://github.com/MB-Team-THI/sparse-graph-attention-optimization. 
    In comparison to GATv2Conv, which uses LeakyRELU activation, 
    GAToptConv uses the Softplus activation. Based on the operation mode, node
